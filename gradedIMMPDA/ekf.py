...
class EKF:
    ...
    def innovation_mean(
        ...
        z_bar = self.sensor_model.h(x)  # TODO predicted measurement

        v = z - z_bar # TODO the innovation
    ...
    def innovation_cov(self,
        ...
        S = H@P@H.transpose()+R  # TODO the innovation covariance
    ...
    def update(self,
        ...
        P_upd = (np.eye(self.dynamic_model.n)-W@H)@P # TODO: the covariance update
    ...
    def loglikelihood(self,
        ...
        ll = -0.5 * (NIS + np.linalg.slogdet(S))
